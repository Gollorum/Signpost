...
public class SignGuiPost extends GuiScreen {
	...
	public void initGui() {
		...
		base1InputBox = new SignInputBox(this.fontRenderer, this.width / 2 - 68, this.height / 2 - 46, 137/*, 20*/);
		base1InputBox.setText(tilebases.sign1.base==null?"":tilebases.sign1.base.toString());
		go1 = true;
		base1InputBox.setFocused(true);
		base2InputBox = new SignInputBox(this.fontRenderer, this.width / 2 - 68, this.height / 2 + 40, 137/*, 20*/);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(base1InputBox==null){
			DoubleBaseInfo tilebases = tile.getBases();
			base1InputBox = new SignInputBox(this.fontRenderer, this.width / 2 - 68, this.height / 2 - 46, 137);
			base1InputBox.setText(tilebases.sign1.base==null?"":tilebases.sign1.base.toString());
		}
		if(base2InputBox==null){
			DoubleBaseInfo tilebases = tile.getBases();
			base2InputBox = new SignInputBox(this.fontRenderer, this.width / 2 - 68, this.height / 2 + 40, 137);
			base2InputBox.setText(tilebases.sign2.base==null?"":tilebases.sign2.base.toString());
		}
