...
public class ConfigHandler {
	...
	public enum RecipeCost {
		...
		public static String[] allValues() {
			String[] ret = { DEACTIVATED.toString(), NORMAL.toString(), EXPENSIVE.toString(),
