...
public class ConfigHandler {
	...
	private static void loadWorldGen() {
		...
		villageWaystonePropability = config.getFloat("villagePropability", category, 0.5f, 0, 1, "Defines the propability of signposts spawning in villages (0 = 0%, 1 = 100%)");
		...
		villageMinSignposts = config.getInt("villageMinSignposts", category, 1, 0, Integer.MAX_VALUE, "The minimum count of signposts spawning in villages");
