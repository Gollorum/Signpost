// Waystones dropped its Forge build with the 26.x line - its last one is 21.11.9 - so there is
// no waystones-forge artifact to compile against and this adapter is disabled on this loader,
// exactly like RepurposedStructuresAdapter. Uncomment (and restore the dependency and
// repository in forge/build.gradle) if Waystones ever ships for Forge again.
