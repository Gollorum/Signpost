...
public class SignGuiPost extends GuiScreen {
	...
	public void initGui() {
		base2InputBox = new GuiTextField(this.fontRendererObj, this.width / 2 - 68, this.height / 2 - 46, 137, 20);
		base2InputBox.setMaxStringLength(23);
		base2InputBox.setText(tile.bases.base1==null?"":tile.bases.base1.toString());
		base1InputBox = new GuiTextField(this.fontRendererObj, this.width / 2 - 68, this.height / 2, 137, 20);
