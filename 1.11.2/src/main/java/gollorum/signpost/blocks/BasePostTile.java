...
public class BasePostTile extends TileEntity {
	...
	public void onBlockDestroy(MyBlockPos pos) {
		...
		if(PostHandler.allWaystones.removeByPos(pos)){
			MinecraftForge.EVENT_BUS.post(new UpdateWaystoneEvent(UpdateWaystoneEvent.WaystoneEventType.DESTROYED, world, this.pos.getX(), this.pos.getY(), this.pos.getZ(), base.name));
