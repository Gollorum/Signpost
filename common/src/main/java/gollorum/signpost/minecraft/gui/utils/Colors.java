...
public class Colors {
     ...
     */
    public static final int validInactive = 0xffdddddd;
    ...
    public static int map(int color, Function<Integer, Integer> mapping) {
        return from(getAlpha(color), mapping.apply(getRed(color)), mapping.apply(getGreen(color)), mapping.apply(getBlue(color)));
    }
