...
public class ShortSignModel {
    ...
    static {
        var modelBuilder = new SignModelFactory<Integer>().makeShortSign(0, 1);
        var overlayBuilder = new SignModelFactory<Integer>().makeShortSignOverlay(0);
